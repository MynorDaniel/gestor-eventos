 ...
 * @author mynordma
 */
public class CrearPagoForm extends javax.swing.JInternalFrame {

    private final Ventana ventana;

    public CrearPagoForm(Ventana ventana) {
        initComponents();
    ...
    private void crearMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_crearMouseClicked
        String[] parametros;
        parametros = new String[]{correoTextField.getText(), codigoTextField.getText(), jComboBox1.getSelectedItem().toString(), montoTextField.getText()};
        ventana.procesarParametros(parametros, TipoInstruccion.PAGO);
